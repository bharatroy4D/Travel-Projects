...
const NewsLatter = () => {
    return (
        <div className='flex justify-between items-center max-w-7xl px-20 my-20 py-10 bg-blue-50'>
            {/* div-1 */}
            <div>
                <div className='flex gap-5 items-center'>
                    ...
                    <div>
                        ...
                        <h1 className='text-3xl font-bold pt-2'>Subscribe to our newsletter</h1>
                    </div>
                </div>
            </div>
